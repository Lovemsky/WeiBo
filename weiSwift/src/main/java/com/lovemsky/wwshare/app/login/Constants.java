...
package com.lovemsky.wwshare.app.login;
...
//    public static final String SCOPE = "all";
    ...
    public static final String APP_KEY = "4274423832";
    public static final String REDIRECT_URL = "http://www.lovemsky.com";
    ...
    public static final String authurl = "https://api.weibo.com/oauth2/authorize" + "?" + "client_id=" + Constants.APP_KEY
